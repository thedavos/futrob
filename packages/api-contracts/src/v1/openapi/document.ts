  ...
  paths: {
      ...
      get: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/GetMyStatisticsResponse" },
              },
            },
          },
          "401": { $ref: "#/components/responses/ApiError" },
    ...
    "/players/me/matches": {
      get: {
        ...
        responses: {
          "200": {
            description: "Cursor page of matched contributions",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/GetMyMatchesResponse" },
              },
            },
          },
          "400": { $ref: "#/components/responses/ApiError" },
    ...
    "/players/me/recent-matches": {
      get: {
        ...
        tags: ["players"],
        summary:
          "List recent provider matches for the selected ExternalClub, including matches the player did not play",
        parameters: [
          {
            name: "externalClubId",
            in: "query",
            required: false,
            description:
              "Associated ExternalClub to fetch. When omitted, appearances from every associated club are returned.",
            schema: { type: "string", minLength: 1 },
          },
        ],
        responses: {
          "200": {
            description:
              "needs_club when no club is associated, needs_game_account when no identifier is registered, or ready club matches classified as played or not_played",
            content: {
              "application/json": {
    ...
    "/organizations/{organizationId}/competitions/{competitionId}": {
      ...
      patch: {
        operationId: "updateCompetitionDraft",
        tags: ["competitions"],
        summary: "Update the editable structure and rules of a competition draft",
        parameters: [
          { name: "organizationId", in: "path", required: true, schema: { type: "string" } },
          { name: "competitionId", in: "path", required: true, schema: { type: "string" } },
        ],
        requestBody: {
          ...
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/UpdateCompetitionDraftInput" },
            },
          },
        },
        responses: {
    ...
    "/organizations/{organizationId}/teams": {
      get: {
        ...
        tags: ["teams"],
        summary: "List teams available to the organization operator",
        parameters: [
          { name: "organizationId", in: "path", required: true, schema: { type: "string" } },
        ],
        responses: {
    ...
    "/organizations/{organizationId}/competitions/{competitionId}/participants": {
      get: {
        operationId: "listCompetitionParticipants",
        tags: ["competitions"],
        summary: "List draft participants",
        parameters: [
          { name: "organizationId", in: "path", required: true, schema: { type: "string" } },
          { name: "competitionId", in: "path", required: true, schema: { type: "string" } },
        ],
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    participants: {
                      type: "array",
                      items: { $ref: "#/components/schemas/CompetitionEntry" },
                    },
                  },
                },
              },
      ...
      post: {
        operationId: "addCompetitionParticipant",
        tags: ["competitions"],
        summary: "Add an approved existing or inline-created Team",
        parameters: [
          { name: "organizationId", in: "path", required: true, schema: { type: "string" } },
          { name: "competitionId", in: "path", required: true, schema: { type: "string" } },
        ],
        requestBody: {
          ...
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/CompetitionParticipantInput" },
            },
          },
        },
        responses: {
          "201": {
            description: "Approved participant",
            content: {
              "application/json": { schema: { $ref: "#/components/schemas/CompetitionEntry" } },
            },
          },
          "400": { $ref: "#/components/responses/ApiError" },
          "403": { $ref: "#/components/responses/ApiError" },
    ...
    "/organizations/{organizationId}/competitions/{competitionId}/participants/{entryId}": {
      delete: {
        operationId: "removeCompetitionParticipant",
        tags: ["competitions"],
        summary: "Remove a participant while the competition is a draft",
        parameters: [
          { name: "organizationId", in: "path", required: true, schema: { type: "string" } },
          { name: "competitionId", in: "path", required: true, schema: { type: "string" } },
    ...
    "/organizations/{organizationId}/competitions/{competitionId}/publish": {
      post: {
        operationId: "publishCompetition",
        tags: ["competitions"],
        summary:
          "Publish and structurally lock a valid draft with at least two approved participants",
        parameters: [
          { name: "organizationId", in: "path", required: true, schema: { type: "string" } },
          { name: "competitionId", in: "path", required: true, schema: { type: "string" } },
        ],
  ...
  components: {
    ...
    parameters: {
      RequestId: {
        ...
        required: false,
        description:
          "Optional caller-supplied UUID. Invalid values are replaced; the effective value is returned in the response.",
    ...
    schemas: {
        ...
        allOf: [
          { $ref: "#/components/schemas/CompetitionDraftInput" },
          {
            ...
            properties: {
              rules: {
                type: "object",
                required: ["regularStage", "knockoutStage", "maxRosterSize"],
                properties: {
                  regularStage: {
                    anyOf: [
                      { $ref: "#/components/schemas/CompetitionMatchRules" },
                      { type: "null" },
                    ],
                  },
                  knockoutStage: {
      ...
      CompetitionEntry: {
        type: "object",
        required: ["id", "organizationId", "competitionId", "teamId", "status", "createdAt"],
        properties: {
          id: { type: "string" },
          organizationId: { type: "string" },
          competitionId: { type: "string" },
        ...
        oneOf: [
          {
            ...
            properties: {
              kind: { type: "string", const: "existing-team" },
              teamId: { type: "string" },
            },
          },
          {
            type: "object",
            required: ["kind", "name", "creationKey"],
            properties: {
              kind: { type: "string", const: "new-team" },
              name: { type: "string", minLength: 1, maxLength: 120 },
              creationKey: { type: "string", minLength: 1, maxLength: 160 },
            },
          },
        ],
      },
      ...
      PlayerPersonalStats: {
        ...
        properties: {
          ...
          totals: {
            ...
            description: "Keyed by PlayerStatisticMetric",
          },
          averages: {
            type: "object",
      ...
      GetMyStatisticsResponse: {
        ...
        properties: {
          statistics: {
            anyOf: [{ $ref: "#/components/schemas/PlayerPersonalStats" }, { type: "null" }],
          },
        },
      },
