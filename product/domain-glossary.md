...
| **EaClubConnection**                     | Asociación operativa entre Team y club EA (id, nombre, plataforma, edición).       | Persistida tras búsqueda y selección para localizar partidos. Es declarativa: no prueba cuenta ni propiedad.                                                                              |
