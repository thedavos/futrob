...
| **PlayerExternalClubAssociation** | Referencia opcional de un PlayerProfile a un ExternalClub.                      | Guarda proveedor, id, nombre, plataforma, edición e imageUrl. Es declarativa; no crea Team o Roster ni verifica propiedad.                                                               |
