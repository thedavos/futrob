...
- Official standings and disputes stay off this list. `/player/statistics` (`Tu perfil`, nav `Mis estadísticas`) is the personal-aggregate page; it currently loads game-profile appearances, not a separate official-history list.
